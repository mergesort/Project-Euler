...
-(void) loadProblems
{
	problemList [0] = @selector(problem1);
	problemList [1] = @selector(problem2);
	problemList [2] = @selector(problem3);
	problemList [3] = @selector(problem4);
	problemList [4] = @selector(problem5);
	problemList [5] = @selector(problem6);
	problemList [6] = @selector(problem7);
	problemList [7] = @selector(problem8);
	problemList [8] = @selector(problem9);
	problemList [9] = @selector(problem10);
	problemList [10] = @selector(problem11);
	problemList [11] = @selector(problem12);
	problemList [12] = @selector(problem13);
	problemList [13] = @selector(problem14);
	problemList [14] = @selector(problem15);
	problemList [15] = @selector(problem16);
	problemList [16] = @selector(problem17);
	problemList [17] = @selector(problem18);
	problemList [18] = @selector(problem19);
	problemList [19] = @selector(problem20);
	problemList [20] = @selector(problem21);
	problemList [21] = @selector(problem22);
	problemList [22] = @selector(problem23);
	problemList [23] = @selector(problem24);
	problemList [24] = @selector(problem25);
	problemList [25] = @selector(problem26);
	problemList [26] = @selector(problem27);
	problemList [27] = @selector(problem28);
	problemList [28] = @selector(problem29);
	problemList [29] = @selector(problem30);
	problemList [30] = @selector(problem31);
	problemList [31] = @selector(problem32);
	problemList [32] = @selector(problem33);
	problemList [33] = @selector(problem34);
	problemList [34] = @selector(problem35);
	problemList [35] = @selector(problem36);
	problemList [36] = @selector(problem37);
	problemList [37] = @selector(problem38);
	problemList [38] = @selector(problem39);
	problemList [39] = @selector(problem40);
	problemList [40] = @selector(problem41);
	problemList [41] = @selector(problem42);
	problemList [42] = @selector(problem43);
	problemList [43] = @selector(problem44);
	problemList [44] = @selector(problem45);
	problemList [45] = @selector(problem46);
	problemList [46] = @selector(problem47);
	problemList [47] = @selector(problem48);
	problemList [48] = @selector(problem49);
	problemList [49] = @selector(problem50);
}
